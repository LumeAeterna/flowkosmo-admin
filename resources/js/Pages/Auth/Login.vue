        ...
        <div class="relative z-10 w-full max-w-md">
            ...
            <div class="bg-obsidian-surface border border-obsidian-border p-8 rounded-lg shadow-2xl relative overflow-hidden">
                ...
                <div class="mb-8 text-center relative">
                    <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-black border border-obsidian-border mb-4 shadow-[0_0_15px_rgba(112,0,255,0.3)]">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/>
                        </svg>
                    </div>
                    <h1 class="text-2xl font-bold text-white tracking-widest">FLOWKOSMO</h1>
